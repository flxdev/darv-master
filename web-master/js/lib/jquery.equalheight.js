    ...
    Plugin.prototype = {
        ...
        magic: function () {
            ...
            for (var i = 0; i < this.elements.length; i++) {
                var height = $(this.elements[i]).innerHeight();
            ...
            for (var j = 0; j < this.elements.length; j++) {
                ...
                if (element.css("display") === "table-cell") {
                    ...
                    if($('.js-height').length){
                        ...
                        element.parents('.js-height').css("height", topHeight +15);
                        element.css("min-height", topHeight);
                    }else {
                        element.parent().css("max-height", topHeight);
                        element.css("min-height", topHeight);
                    }
                }
            }
        ...
        reset: function () {
            ...
            this.elements.parent().css("max-height", "");
